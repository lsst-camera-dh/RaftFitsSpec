...
& {\tt CRVAL1A} =  1 - {\rm preh} \\
& {\tt CRVAL2A} =  S_y \times {\rm dimv} + 1 & \\
& {\tt PC1\_1C} = 1 & \\
& {\tt PC1\_2C} = 0 & \\
& {\tt PC2\_1C} = 0 & \\
& {\tt PC2\_2C} = 1 - 2 \times S_y & \\
& {\tt CRVAL1C} = 1 - {\rm preh} + (7-S_x) \times {\rm dimh} & \\
& {\tt CRVAL2C} = 2 \times S_y \times {\rm dimv} + 1  & \\ 
& {\tt PC1\_1R} = 1 & \\
& {\tt PC1\_2R} = 0 & \\
& {\tt PC2\_1R} = 0 & \\
& {\tt PC2\_2R} = 1 - 2 \times S_y & \\
& {\tt CRVAL1R} = 1 - {\rm preh} + (7-S_x) \times {\rm dimh} + {\rm overh} + {\rm ccday} + ({\rm ccdpx} - {\rm ccdax})/2 + {\rm xoff1} + {\rm xoff2} & \\  
& {\tt CRVAL2R} = 2 \times S_y \times {\rm dimh} + 1 - {\rm preh} + S_y \times {\rm dimv} + ({\rm ccdpy} - {\rm ccday})/2 & \\ 
& {\tt PC1\_1F} = 1 & \\
& {\tt PC1\_2F} = 0 & \\
& {\tt PC2\_1F} = 0 & \\
& {\tt PC2\_2F} = 1 - 2 \times S_y & \\
& {\tt CRVAL1F} = 1 - {\rm preh} + (7-S_x) \times {\rm dimh} + {\rm overh} + {\rm ccday} + ({\rm ccdpx} - {\rm ccdax})/2 + {\rm xoff1} + {\rm xoff2} + R_x \times {\rm raftx} &  \\ 
& {\tt CRVAL2F} = 2 \times S_y \times {\rm dimh} + 1 - {\rm preh} + S_y \times {\rm dimv} + ({\rm ccdpy} - {\rm ccday})/2 + R_y \times {\rm rafty} & \\  
& {\tt PC1\_1B} = 0 & \\
...
& {\tt PC2\_1C} = -1 & \\
& {\tt PC2\_2C} = 0 & \\
& {\tt CRVAL1C} = S_x \times {\rm dimv} + 1 - {\rm preh}  + S_x \times {\rm dimv} & \\
& {\tt CRVAL2C} =  {\rm dimh} + 1 - {\rm preh} + S_y \times {\rm dimh}  &  \\ 
& {\tt PC1\_1R} = 0 & \\
& {\tt PC1\_2R} = -1 + 2 \times S_y & \\
& {\tt PC2\_1R} = -1) & \\
& {\tt PC2\_2R} = 0 & \\
& {\tt CRVAL1R} = S_y \times {\rm dimv} + 1 - {\rm preh}  + S_y \times {\rm dimv} + ({\rm ccdpy} - {\rm ccday})/2 & \\
& {\tt CRVAL2R} =  {\rm dimh} + 1 - {\rm preh} + S_y \times {\rm dimh} + {\rm yoff1} + {\rm yoff2} + 8 \times {\rm dimh} + {\rm ccdpy} -  {\rm ccday} + {\rm overhang} & \\
& {\tt PC1\_1F} = 0 & \\
& {\tt PC1\_2F} = -1 + 2 \times S_x & \\
& {\tt PC2\_1F} = -1 &  \\
& {\tt PC2\_2F} =  0 & \\
& {\tt CRVAL1F} =S_x \times {\rm dimv} + 1 - {\rm preh}  + S_x \times {\rm dimv} + ({\rm ccdpy} - {\rm ccday})/2  + R_x \times {\rm raftx} & \\ 
...
& {\tt PC2\_1F} = -1 & \\
& {\tt PC2\_2F} = 0 & \\
& {\tt CRVAL1F} = 1 + ({\rm ccdpy} - {\rm ccday})\times (3/4) + {\rm dimv} + {\rm offx1} + R_x \times {\rm raftx} & \\ 
...
& {\tt CRVAL1C} = 1 + {\rm preh} + (8-S_x) \times {\rm dimh} & \\
& {\tt CRVAL2C} = 1 + 2 \times (1 - S_y) \times {\rm dimv}  & \\ 
& {\tt PC1\_1R} = -1 & \\
& {\tt PC1\_2R} = 0 & \\
& {\tt PC2\_1R} = 0 & \\
& {\tt PC2\_2R} = 2 \times S_y - 1 & \\
& {\tt CRVAL1R} = 1 + {\rm preh} + (8-S_x) \times {\rm dimh} + {\rm crdim} - {\rm xoff1} - {\rm xoff2} - {\rm ccdpy} - {\rm ccdpx} & \\ 
& {\tt CRVAL2R} = 1 + 2 \times (1 - S_y) \times {\rm dimv} + {\rm crdim} - {\rm ccdpy}  & \\ 
& {\tt PC1\_1F} = -1 & \\
& {\tt PC1\_2F} = 0 & \\
& {\tt PC2\_1F} = 0 & \\
...
& {\tt CRVAL2F} = 2 \times S_y \times {\rm dimh} + 1 - {\rm preh} + S_x \times {\rm dimv} + ({\rm ccdpy} - {\rm ccday})/2 + R_y \times {\rm rafty} & \\  
& {\tt PC1\_1B} = 0 & \\
& {\tt PC1\_2B} =  1 - 2 \times S_p & \\
& {\tt PC2\_1B} = -1 &  \\
& {\tt PC2\_2B} = 0 &  \\
...
& {\tt PC2\_1A} = 1 &  \\
& {\tt PC2\_2A} = 0 & \\
& {\tt CRVAL1A} =   (1-S_y) \times {\rm dimv} + 1 - {\rm preh} & \\
& {\tt CRVAL2A} =  1 - {\rm preh}  & \\
& {\tt PC1\_1C} = 0 & \\
& {\tt PC1\_2C} = -1 + 2 \times S_y & \\
& {\tt PC2\_1C} = 1 & \\
& {\tt PC2\_2C} = 0 & \\
& {\tt CRVAL1C} = (1-S_y) \times {\rm dimv} + 1 - {\rm preh} & \\
& {\tt CRVAL2C} =  1 - {\rm preh} + (7 - S_x) \times {\rm dimh}   &  \\ 
& {\tt PC1\_1R} = 0 & \\
& {\tt PC1\_2R} = -1 + 2 \times S_x & \\
& {\tt PC2\_1R} = 1) & \\
& {\tt PC2\_2R} = 0 & \\
& {\tt CRVAL1R} = (1-S_y) \times {\rm dimv} + 1 - {\rm preh} + {\rm crdim} - {\rm xoff1} - {\rm xoff2} -  {\rm ccdpy}  + ({\rm ccdpy} - {\rm ccday})/2 & \\
& {\tt CRVAL2R} =  1 - {\rm preh} + (7 - S_x) \times {\rm dimh} +   {\rm crdim} - {\rm xoff1} - {\rm xoff2} - 2 \times {\rm ccdpy}  - ({\rm ccdpy} - {\rm ccday})/2 + {\rm overhang} & \\
& {\tt PC1\_1F} = 0 & \\
& {\tt PC1\_2F} = -1 + 2 \times S_x & \\
& {\tt PC2\_1F} = 1  )&  \\
& {\tt PC2\_2F} =  0 & \\
& {\tt CRVAL1F} = (1-S_y) \times {\rm dimv} + 1 - {\rm preh} + {\rm crdim} - {\rm xoff1} - {\rm xoff2} -  {\rm ccdpy}  + ({\rm ccdpy} - {\rm ccday})/2  + R_x \times {\rm raftx} & \\ 
& {\tt CRVAL2F} =  1 - {\rm preh} + (7 - S_x) \times {\rm dimh} +   {\rm crdim} - {\rm xoff1} - {\rm xoff2} - 2 \times {\rm ccdpy}  - ({\rm ccdpy} - {\rm ccday})/2 + {\rm overhang} + R_y \times {\rm rafty} & \\  
& {\tt PC1\_1B} = -1 &   \\
& {\tt PC1\_2B} = 0 & \\
& {\tt PC2\_1B} = 0 & \\
& {\tt PC2\_2B} =  -1 + 2 \times S_p & \\
...
& {\tt CRVAL2R} =  1 + {\rm dimh} - {\rm preh} + S_s \times {\rm dimh} + {\rm crdim} - {\rm yoff1} - {\rm ccdpx}  + ({\rm ccdpy} - {\rm ccday})/4 & \\ 
& {\tt PC1\_1F} = 0 & \\
& {\tt PC1\_2F} = 1  & \\
& {\tt PC2\_1F} = -1 & \\
& {\tt PC2\_2F} = 0 & \\
& {\tt CRVAL1F} = {\rm crdim} - {\rm ccdpy}/2 + ({\rm ccdpy} - {\rm ccday})/2   + R_x \times {\rm raftx} & \\ 
& {\tt CRVAL2F} = 1 + {\rm dimh} - {\rm preh} + S_s \times {\rm dimh} + {\rm crdim} - {\rm yoff1} - {\rm ccdpx}  + ({\rm ccdpy} - {\rm ccday})/4 + R_y \times {\rm rafty} & \\  
& {\tt PC1\_1B} = 1 &   \\
& {\tt PC1\_2B} = 0 & \\
& {\tt PC2\_1B} = 0 & \\
& {\tt PC2\_2B} =  1 & \\
...
& {\tt PC2\_1F} = 1 & \\
& {\tt PC2\_2F} = 0 & \\
& {\tt CRVAL1F} = {\rm dimv} + 1 + {\rm crdim} - {\rm overhang} - {\rm ccdpy} - {\rm xoff1} + ({\rm ccdpy} - {\rm ccday})\times (1/4) + R_x \times {\rm raftx} & \\ 
...
& {\tt PC2\_1A} = 1 & \\
& {\tt PC2\_2A} = 0 & \\
& {\tt CRVAL1A} =  1 + 2 \times (1 - S_y) \times {\rm dimv} \\
& {\tt CRVAL2A} =  1 - {\rm preh}  & \\
& {\tt PC1\_1C} = 0 & \\
& {\tt PC1\_2C} = -1 + 2 \times S_y & \\
& {\tt PC2\_1C} = 1 & \\
& {\tt PC2\_2C} = 0 & \\
& {\tt CRVAL1C} = 1 + 2 \times (1 - S_y) \times {\rm dimv} & \\
& {\tt CRVAL2C} = 1 - {\rm preh} + (7 - S_x) \times {\rm dimh}  & \\ 
& {\tt PC1\_1R} = 0 & \\
& {\tt PC1\_2R} = -1 + 2 \times S_y & \\
& {\tt PC2\_1R} = 1 & \\
& {\tt PC2\_2R} = 0 & \\
& {\tt CRVAL1R} = 1 + 2 \times (1 - S_y) \times {\rm dimv} + {\rm crdim} + {\rm overhang} - {\rm ccdpy} + ({\rm ccdpy} - {\rm ccday})/2 & \\ 
& {\tt CRVAL2R} = 1 - {\rm preh} + (7 - S_x) \times {\rm dimh} + {\rm overhang} + {\rm ccdpy} + {\rm xoff1} + {\rm xoff2} + ({\rm ccdpx} - {\rm ccdax})  & \\ 
& {\tt PC1\_1F} = 0 & \\
...
& {\tt CRVAL2F} = 1 - {\rm preh} + (7 - S_x) \times {\rm dimh} + {\rm overhang} + {\rm ccdpy} + {\rm xoff1} + {\rm xoff2} + ({\rm ccdpx} - {\rm ccdax}) + R_y \times {\rm rafty} & \\  
& {\tt PC1\_1B} = -1 & \\
& {\tt PC1\_2B} =  0 & \\
& {\tt PC2\_1B} = 0 &  \\
& {\tt PC2\_2B} = -1 + 2 \times S_p &  \\
...
& {\tt PC2\_1R} = 0 & \\
& {\tt PC2\_2R} = 1 - 2 \times S_y & \\
& {\tt CRVAL1R} = 1 - {\rm preh}  + (7 - S_x) \times {\rm dimh} + {\rm crdim} + {\rm overhang} - {\rm yoff1} - {\rm yoff2} - {\rm ccdpy} - ({\rm ccdpx} - {\rm ccdax})/2 & \\
& {\tt CRVAL2R} =  1 + 2 \times S_x \times {\rm dimv}  & \\
& {\tt PC1\_1F} = 1 & \\
& {\tt PC1\_2F} = 0 & \\
& {\tt PC2\_1F} = 0 & \\
& {\tt PC2\_2F} =  1 - 2 \times S_y & \\
& {\tt CRVAL1F} = 1 - {\rm preh}  + (7 - S_x) \times {\rm dimh} + {\rm crdim} + {\rm overhang} - {\rm yoff1} - {\rm yoff2} - {\rm ccdpy} - ({\rm ccdpx} - {\rm ccdax})/2 + R_x \times {\rm raftx} & \\ 
...
& {\tt PC2\_1F} = 1 & \\
& {\tt PC2\_2F} = 0 & \\
& {\tt CRVAL1F} =  {\rm dimv} + 1 + {\rm crdim} + {\rm overhang} - {\rm ccdpy} - {\rm xoff1} + ({\rm ccdpy} - {\rm ccday})/4  + R_x \times {\rm raftx} & \\ 
...
& {\tt PC2\_1A} = -1 & \\
& {\tt PC2\_2A} = 0 & \\
& {\tt CRVAL1A} =  1 + S_y \times {\rm dimv} \\
& {\tt CRVAL2A} =  1 + {\rm dimh} - {\rm preh}  & \\
& {\tt PC1\_1C} = 0 & \\
& {\tt PC1\_2C} = 1 - 2 \times S_y& \\
& {\tt PC2\_1C} = -1 & \\
& {\tt PC2\_2C} = 0 & \\
& {\tt CRVAL1C} = 1 + 2 \times S_y \times {\rm dimv} & \\
& {\tt CRVAL2C} = 1 - {\rm preh} + (8 - S_x) \times {\rm dimh}  & \\ 
& {\tt PC1\_1R} = 0 & \\
& {\tt PC1\_2R} = 1 - 2 \times S_y & \\
& {\tt PC2\_1R} = -1 & \\
& {\tt PC2\_2R} = 0 & \\
& {\tt CRVAL1R} = 1 + 2 \times S_y \times {\rm dimv} + ({\rm ccdpy} - {\rm ccday})/2 & \\ 
& {\tt CRVAL2R} = 1 - {\rm preh} + (8 - S_x) \times {\rm dimh} + {\rm crdim} - {\rm ccdpy} - {\rm xoff1} - {\rm xoff2} + ({\rm ccdpx} - {\rm ccdax})/2 & \\ 
& {\tt PC1\_1F} = 0 & \\
& {\tt PC1\_2F} = 1 - 2 \times S_y & \\
& {\tt PC2\_1F} = -1 & \\
& {\tt PC2\_2F} = 0 & \\
& {\tt CRVAL1F} = 1 + 2 \times S_y \times {\rm dimv} + ({\rm ccdpy} - {\rm ccday})/2 + R_x \times {\rm raftx} &  \\ 
& {\tt CRVAL2F} = 1 - {\rm preh} + (8 - S_x) \times {\rm dimh} + {\rm crdim} - {\rm ccdpy} - {\rm xoff1} - {\rm xoff2} + ({\rm ccdpx} - {\rm ccdax})/2 + R_y \times {\rm rafty} & \\  
& {\tt PC1\_1B} = 1 & \\
& {\tt PC1\_2B} =  0 & \\
& {\tt PC2\_1B} = 0 &  \\
& {\tt PC2\_2B} = 1 - 2 \times S_p &  \\
