...
\red{16 Sep 2019: Fixed some equations for corner raft keyword values}
\red{22 Aug 2019:  Updated Table 1 to include slot designators for corner raft sensors}
...
{\bf .../<raft ID>/<run ID>/<acquisition type>/<test version>/<job ID>/S<2-digit location in raft>}
...
{\bf <raft ID>} & Hardware ID of the raft, e.g., LCA-10753\_RSA-003\_ETU1 \\
...
{\bf <S\#\#>} & Location designator of the sensor in the raft \red{(for science rafts, each \# = 0--2; for corner rafts \#\# = G0, G1, W0, or W1 for the guider and wavefront sensors)} \\
\hline
\end{tabular}
...
An example with the desired directory path:

{\tt .../LCA-10753\_RSA-003\_ETU1/1234/dark\_acq/v0/36123/S12/ \\ E2V-CCD250-088\_dark\_dark\_003\_1234\_20160121191343.fits}}
...
\end{equation}
\begin{equation}
y_c = (1 - S_x) ( y_s + 1) +  S_x \times ({2\rm dimv} - y_s)   %{\rm dimv}
\end{equation}
\begin{equation}
...
%In R40, G0 is aligned as for the ITL sensors in the science rafts
%In R44, G1 is aligned as for the ITL sensors in the science rafts
...
& {\tt CRVAL2A} =  1 + (1 - S_x) \times {\rm dimv} & \\
& {\tt PC1\_1C} = -1 & \\
& {\tt PC1\_2C} = 0 & \\
& {\tt PC2\_1C} = 0 & \\
& {\tt PC2\_2C} = 2 \times S_x - 1 & \\
& {\tt CRVAL1C} = 1 - {\rm preh} + (8 - S_y) \times {\rm dimh} & \\
& {\tt CRVAL2C} = 1 + 2 \times (1 - S_x) \times {\rm dimv}  & \\ 
& {\tt PC1\_1R} = -1 & \\
& {\tt PC1\_2R} = 0 & \\
& {\tt PC2\_1R} = 0 & \\
& {\tt PC2\_2R} = 2 \times S_x - 1 & \\
& {\tt CRVAL1R} = 1 - {\rm preh} + (8 - S_y) \times {\rm dimh} + {\rm crdim} + {\rm overhang} - {\rm xoff1} - {\rm xoff2} - {\rm ccdpx} - ({\rm ccdpy} - {\rm ccday})/2 & \\ 
& {\tt CRVAL2R} = 1 + 2 \times (1 - S_x) \times {\rm dimv} + {\rm crdim} - {\rm ccdpy}  & \\ 
& {\tt PC1\_1F} = -1 & \\
& {\tt PC1\_2F} = 0 & \\
& {\tt PC2\_1F} = 0 & \\
& {\tt PC2\_2F} = 2 \times S_x - 1 & \\
& {\tt CRVAL1F} = 1 - {\rm preh} + (8 - S_y) \times {\rm dimh} + {\rm crdim} + {\rm overhang} - {\rm xoff1} - {\rm xoff2} - {\rm ccdpx} - ({\rm ccdpy} - {\rm ccday})/2 + R_x \times {\rm raftx} &  \\ 
& {\tt CRVAL2F} = 1 + 2 \times (1 - S_x) \times {\rm dimv} + {\rm crdim} - {\rm ccdpy} + R_y \times {\rm rafty} & \\  
& {\tt PC1\_1B} = 0 & \\
& {\tt PC1\_2B} =  1 - 2 \times S_p & \\
& {\tt PC2\_1B} = -1 &  \\
& {\tt PC2\_2B} = 0 &  \\
& {\tt CRVAL1B} = 2 \times S_p \times {\rm dimv} + 1  & \\ 
& {\tt CRVAL2B} = 1 - {\rm preh} + (8-S_s) \times {\rm dimh} & \\
& {\tt PC1\_1Q} = 0  &  \\
& {\tt PC1\_2Q} = 1 - 2 \times S_p  & \\
& {\tt PC2\_1Q} = -1 & \\
& {\tt PC2\_2Q} = 0  & \\
& {\tt CRVAL1Q} = 2 \times S_p \times {\rm dimv} + 1  & \\
& {\tt CRVAL2Q} = 1 - {\rm preh} + (8 - S_s) \times {\rm dimh} + {\rm crdim} - {\rm ccdpx} - {\rm xoff1} - {\rm xoff2} - ({\rm ccdpx} - {\rm ccdax})/2 &  \\
\end{flalign*}
...
& {\tt PC2\_1A} = 1 &  \\
& {\tt PC2\_2A} = 0 & \\
& {\tt CRVAL1A} =   (1-S_x) \times {\rm dimv} + 1 - {\rm preh} & \\
& {\tt CRVAL2A} =  1 - {\rm preh}  & \\
& {\tt PC1\_1C} = 0 & \\
& {\tt PC1\_2C} = -1 + 2 \times S_x & \\
& {\tt PC2\_1C} = 1 & \\
& {\tt PC2\_2C} = 0 & \\
& {\tt CRVAL1C} = (1-S_x) \times {\rm dimv} + 1 - {\rm preh} & \\
& {\tt CRVAL2C} =  1 - {\rm preh} + (7 - S_y) \times {\rm dimh}   &  \\ 
& {\tt PC1\_1R} = 0 & \\
& {\tt PC1\_2R} = -1 + 2 \times S_x & \\
& {\tt PC2\_1R} = 1) & \\
& {\tt PC2\_2R} = 0 & \\
& {\tt CRVAL1R} = (1-S_x) \times {\rm dimv} + 1 - {\rm preh} + {\rm crdim} - {\rm xoff1} - {\rm xoff2} -  {\rm ccdpy}  + ({\rm ccdpy} - {\rm ccday})/2 & \\
& {\tt CRVAL2R} =  1 - {\rm preh} + (7 - S_y) \times {\rm dimh} +   {\rm crdim} - {\rm xoff1} - {\rm xoff2} - 2 \times {\rm ccdpy}  - ({\rm ccdpy} - {\rm ccday})/2 + {\rm overhang} & \\
& {\tt PC1\_1F} = 0 & \\
& {\tt PC1\_2F} = -1 + 2 \times S_x & \\
& {\tt PC2\_1F} = 1  )&  \\
& {\tt PC2\_2F} =  0 & \\
& {\tt CRVAL1F} = (1-S_x) \times {\rm dimv} + 1 - {\rm preh} + {\rm crdim} - {\rm xoff1} - {\rm xoff2} -  {\rm ccdpy}  + ({\rm ccdpy} - {\rm ccday})/2  + R_x \times {\rm raftx} & \\ 
& {\tt CRVAL2F} =  1 - {\rm preh} + (7 - S_y) \times {\rm dimh} +   {\rm crdim} - {\rm xoff1} - {\rm xoff2} - 2 \times {\rm ccdpy}  - ({\rm ccdpy} - {\rm ccday})/2 + {\rm overhang} + R_y \times {\rm rafty} & \\  
& {\tt PC1\_1B} = -1 &   \\
& {\tt PC1\_2B} = 0 & \\
& {\tt PC2\_1B} = 0 & \\
& {\tt PC2\_2B} =  -1 + 2 \times S_p & \\
& {\tt CRVAL1B} =  (S_s + 1) \times {\rm dimh} + 1 - {\rm preh} & \\ 
& {\tt CRVAL2B} = 1 + 2 \times (1 - S_p) \times {\rm dimv} & \\
& {\tt PC1\_1Q} = -1  &  \\
& {\tt PC1\_2Q} = 0 & \\
& {\tt PC2\_1Q} = 0 & \\
& {\tt PC2\_2Q} = -1 + 2 \times S_p & \\
& {\tt CRVAL1Q} = (S_s + 1) \times {\rm dimh} + 1 - {\rm preh} + {\rm overhang} + {\rm yoff1} + {\rm yoff2} + ({\rm ccdpy} - {\rm ccday})/2  &  \\
& {\tt CRVAL2Q} = 1 + 2 \times (1 - S_p) \times {\rm dimv} + {\rm crdim} - {\rm ccdpy} + ({\rm ccdpy} - {\rm ccday})/2 &  \\
\end{flalign*}
...
& {\tt PC2\_2C} = 0 &  \\
& {\tt CRVAL1C} = 1 &  \\
& {\tt CRVAL2C} =  1 + {\rm dimh} - {\rm preh} + S_s \times {\rm dimh}  & \\ 
& {\tt PC1\_1R} = 0 & \\
& {\tt PC1\_2R} = 1  & \\
& {\tt PC2\_1R} = -1 & \\
& {\tt PC2\_2R} = 0 & \\
& {\tt CRVAL1R} = {\rm crdim} - {\rm ccdpy}/2 + ({\rm ccdpy} - {\rm ccday})/2 &  \\
& {\tt CRVAL2R} =  1 + {\rm dimh} - {\rm preh} + S_s \times {\rm dimh} + {\rm crdim} - {\rm yoff1} - {\rm ccdpx}  + ({\rm ccdpx} - {\rm ccdax})/4 & \\ 
& {\tt PC1\_1F} = 0 & \\
& {\tt PC1\_2F} = 1  & \\
& {\tt PC2\_1F} = -1 & \\
& {\tt PC2\_2F} = 0 & \\
& {\tt CRVAL1F} = {\rm crdim} - {\rm ccdpy}/2 + ({\rm ccdpy} - {\rm ccday})/2   + R_x \times {\rm raftx} & \\ 
& {\tt CRVAL2F} = 1 + {\rm dimh} - {\rm preh} + S_s \times {\rm dimh} + {\rm crdim} - {\rm yoff1} - {\rm ccdpx}  + ({\rm ccdpx} - {\rm ccdax})/4 + R_y \times {\rm rafty} & \\  
& {\tt PC1\_1B} = 1 &   \\
& {\tt PC1\_2B} = 0 & \\
& {\tt PC2\_1B} = 0 & \\
& {\tt PC2\_2B} =  1 & \\
& {\tt CRVAL1B} =  S_s \times {\rm dimh} + 1 - {\rm preh} & \\ 
& {\tt CRVAL2B} = 1 &  \\
& {\tt PC1\_1Q} = 1 &   \\
& {\tt PC1\_2Q} = 0 & \\
& {\tt PC2\_1Q} = 0 & \\
& {\tt PC2\_2Q} = 1 & \\ 
& {\tt CRVAL1Q} = S_s \times {\rm dimh} + 1 - {\rm preh} + {\rm overhang} + ({\rm ccdpy} - {\rm ccday})/2 & \\
...
& {\tt PC2\_2C} = 0 & \\
& {\tt CRVAL1C} = {\rm dimv} + 1 &  \\
& {\tt CRVAL2C} =  1 - {\rm preh} + (7 - S_s) \times {\rm dimh} &  \\ 
& {\tt PC1\_1R} = 0 & \\
& {\tt PC1\_2R} = -1 &  \\
& {\tt PC2\_1R} = 1 & \\
& {\tt PC2\_2R} = 0 & \\
& {\tt CRVAL1R} = {\rm dimv} + 1 + {\rm crdim} - {\rm overhang} - {\rm ccdpy} - {\rm xoff1} + ({\rm ccdpx} - {\rm ccdax})\times (1/4) & \\
& {\tt CRVAL2R} =   1 - {\rm preh} + (7 - S_s) \times {\rm dimh} + {\rm crdim} + {\rm overhang} - {\rm yoff1} - {\rm ccdpx}  + ({\rm ccdpx} - {\rm ccdax})/2 & \\ 
& {\tt PC1\_1F} = 0 & \\
& {\tt PC1\_2F} = -1  & \\
& {\tt PC2\_1F} = 1 & \\
& {\tt PC2\_2F} = 0 & \\
& {\tt CRVAL1F} = {\rm dimv} + 1 + {\rm crdim} - {\rm overhang} - {\rm ccdpy} - {\rm xoff1} + ({\rm ccdpx} - {\rm ccdax})\times (1/4) + R_x \times {\rm raftx} & \\ 
& {\tt CRVAL2F} = 1 - {\rm preh} + (7 - S_s) \times {\rm dimh} + {\rm crdim} + {\rm overhang} - {\rm yoff1} - {\rm ccdpx}  + ({\rm ccdpx} - {\rm ccdax})/2 + R_y \times {\rm rafty} & \\  
& {\tt PC1\_1B} = -1 &   \\
& {\tt PC1\_2B} = 0 & \\
& {\tt PC2\_1B} = 0 & \\
& {\tt PC2\_2B} =  -1 &  \\
...
& {\tt PC2\_1Q} = 0 & \\
& {\tt PC2\_2Q} = -1 &  \\ 
& {\tt CRVAL1Q} = (S_s + 1) \times {\rm dimh} + 1 - {\rm preh}  + {\rm overhang} + {\rm yoff1} + ({\rm ccdpy} - {\rm ccday})/2 & \\
...
& {\tt PC2\_1A} = 1 & \\
& {\tt PC2\_2A} = 0 & \\
& {\tt CRVAL1A} =  1 + 2 \times (1 - S_x) \times {\rm dimv} \\
& {\tt CRVAL2A} =  1 - {\rm preh}  & \\
& {\tt PC1\_1C} = 0 & \\
& {\tt PC1\_2C} = -1 + 2 \times S_x & \\
& {\tt PC2\_1C} = 1 & \\
& {\tt PC2\_2C} = 0 & \\
& {\tt CRVAL1C} = 1 + 2 \times (1 - S_x) \times {\rm dimv} & \\
& {\tt CRVAL2C} = 1 - {\rm preh} + (7 - S_y) \times {\rm dimh}  & \\ 
& {\tt PC1\_1R} = 0 & \\
& {\tt PC1\_2R} = -1 + 2 \times S_x & \\
& {\tt PC2\_1R} = 1 & \\
& {\tt PC2\_2R} = 0 & \\
& {\tt CRVAL1R} = 1 + 2 \times (1 - S_x) \times {\rm dimv} + {\rm crdim} + {\rm overhang} - {\rm ccdpy} + ({\rm ccdpy} - {\rm ccday})/2 & \\ 
& {\tt CRVAL2R} = 1 - {\rm preh} + (7 - S_y) \times {\rm dimh} + {\rm overhang} + {\rm ccdpy} + {\rm xoff1} + {\rm xoff2} + ({\rm ccdpx} - {\rm ccdax})  & \\ 
& {\tt PC1\_1F} = 0 & \\
& {\tt PC1\_2F} = -1 + 2 \times S_x & \\
& {\tt PC2\_1F} = 1 & \\
& {\tt PC2\_2F} = 0 & \\
& {\tt CRVAL1F} = 1 + 2 \times (1 - S_x) \times {\rm dimv} + {\rm crdim} + {\rm overhang} - {\rm ccdpy} + ({\rm ccdpy} - {\rm ccday})/2 + R_x \times {\rm raftx} &  \\ 
& {\tt CRVAL2F} = 1 - {\rm preh} + (7 - S_y) \times {\rm dimh} + {\rm overhang} + {\rm ccdpy} + {\rm xoff1} + {\rm xoff2} + ({\rm ccdpx} - {\rm ccdax}) + R_y \times {\rm rafty} & \\  
& {\tt PC1\_1B} = -1 & \\
& {\tt PC1\_2B} =  0 & \\
& {\tt PC2\_1B} = 0 &  \\
& {\tt PC2\_2B} = -1 + 2 \times S_p &  \\
& {\tt CRVAL1B} = 1 - {\rm preh} + (8 - S_s) \times {\rm dimh}  & \\ 
& {\tt CRVAL2B} = 1 + 2 \times {\rm dimv} \times (1 - S_p) & \\
& {\tt PC1\_1Q} = -1  &  \\
& {\tt PC1\_2Q} = 0  & \\
& {\tt PC2\_1Q} = 0 & \\
& {\tt PC2\_2Q} = -1 + 2 \times S_p  & \\
& {\tt CRVAL1Q} = 1 - {\rm preh} + (8 - S_s) \times {\rm dimh} + {\rm crdim} + {\rm overhang} + {\rm ccdpy} + {\rm xoff1 } + {\rm xoff2} + ({\rm ccdpx} - {\rm ccdax})/2  & \\
& {\tt CRVAL2Q} =  1 + 2 \times {\rm dimv} \times (1 - S_p) + {\rm crdim} + {\rm overhang} - {\rm ccdpy} + ({\rm ccdpy} - {\rm ccday})/2 &  \\
\end{flalign*}
...
& {\tt CRVAL1A} =  1 - {\rm preh} & \\
& {\tt CRVAL2A} =  1 +  S_x \times {\rm dimv}  & \\
& {\tt PC1\_1C} = 1 & \\
& {\tt PC1\_2C} = 0 & \\
& {\tt PC2\_1C} = 0 & \\
& {\tt PC2\_2C} = 1 - 2 \times S_x & \\
& {\tt CRVAL1C} = 1 - {\rm preh}  + (7 - S_y) \times {\rm dimh} & \\
& {\tt CRVAL2C} =  1 + 2 \times S_x \times {\rm dimv}  &  \\ 
& {\tt PC1\_1R} = 1 & \\
& {\tt PC1\_2R} = 0 & \\
& {\tt PC2\_1R} = 0 & \\
& {\tt PC2\_2R} = 1 - 2 \times S_x & \\
& {\tt CRVAL1R} = 1 - {\rm preh}  + (7 - S_y) \times {\rm dimh} + {\rm crdim} + {\rm overhang} - {\rm yoff1} - {\rm yoff2} - {\rm ccdpy} - ({\rm ccdpx} - {\rm ccdax})/2 & \\
& {\tt CRVAL2R} =  1 + 2 \times S_x \times {\rm dimv}  & \\
& {\tt PC1\_1F} = 1 & \\
& {\tt PC1\_2F} = 0 & \\
& {\tt PC2\_1F} = 0 & \\
& {\tt PC2\_2F} =  1 - 2 \times S_x & \\
& {\tt CRVAL1F} = 1 - {\rm preh}  + (7 - S_y) \times {\rm dimh} + {\rm crdim} + {\rm overhang} - {\rm yoff1} - {\rm yoff2} - {\rm ccdpy} - ({\rm ccdpx} - {\rm ccdax})/2 + R_x \times {\rm raftx} & \\ 
& {\tt CRVAL2F} =  1 + 2 \times S_x \times {\rm dimv} + R_y \times {\rm rafty} & \\  
& {\tt PC1\_1B} = 0 &   \\
& {\tt PC1\_2B} = -1 + 2 \times S_p  & \\
& {\tt PC2\_1B} = 1 & \\
& {\tt PC2\_2B} =  0 & \\
& {\tt CRVAL1B} =  1 + 2 \times (1 - S_p) \times {\rm dimv} & \\ 
& {\tt CRVAL2B} = 1 - {\rm preh} + (7 - S_s) \times {\rm dimh} & \\
& {\tt PC1\_1Q} = 0 &  \\
& {\tt PC1\_2Q} = -1 + 2 \times S_p & \\
& {\tt PC2\_1Q} = 1 & \\
& {\tt PC2\_2Q} = 0 & \\
& {\tt CRVAL1Q} = 1 + 2 \times (1 - S_p) \times {\rm dimv} + {\rm crdim} + {\rm overhang} - {\rm ccdpy} - ({\rm ccdpy} - {\rm ccday})/2 &  \\
& {\tt CRVAL2Q} = 1 - {\rm preh} + (7 - S_s) \times {\rm dimh} + {\rm crdim} + {\rm overhang} - {\rm yoff1} - {\rm yoff2} - 2 \times {\rm ccdpx} - ({\rm ccdpx} - {\rm ccdax})/2 &  \\
\end{flalign*}
...
& {\tt PC2\_1C} = 0 & \\
& {\tt PC2\_2C} = -1 &  \\
& {\tt CRVAL1C} = 1 + {\rm dimh} - {\rm preh} + S_s \times {\rm dimh} &  \\
& {\tt CRVAL2C} =  1 + {\rm dimv} & \\ 
& {\tt PC1\_1R} = -1 & \\
& {\tt PC1\_2R} = 0  & \\
& {\tt PC2\_1R} = 0 & \\
& {\tt PC2\_2R} = -1 & \\
& {\tt CRVAL1R} = 1 + {\rm dimh} - {\rm preh} + S_s \times {\rm dimh} + {\rm crdim} + {\rm overhang} - {\rm yoff1} - {\rm ccdpx} - ({\rm ccdpx} - {\rm ccdax})/2 &  \\
& {\tt CRVAL2R} =  1 + {\rm dimv} + {\rm overhang} & \\ 
& {\tt PC1\_1F} = -1 & \\
& {\tt PC1\_2F} = 0  & \\
& {\tt PC2\_1F} = 0 & \\
& {\tt PC2\_2F} = -1 & \\
& {\tt CRVAL1F} = 1 + {\rm dimh} - {\rm preh} + S_s \times {\rm dimh} + {\rm crdim} + {\rm overhang} - {\rm yoff1} - {\rm ccdpx} - ({\rm ccdpx} - {\rm ccdax})/2 + R_x \times {\rm raftx} & \\ 
& {\tt CRVAL2F} = 1 + {\rm dimv} + {\rm overhang} + R_y \times {\rm rafty} & \\  
& {\tt PC1\_1B} = 0 &   \\
& {\tt PC1\_2B} = 1 & \\
& {\tt PC2\_1B} = -1 & \\
& {\tt PC2\_2B} = 0 & \\
& {\tt CRVAL1B} = 1 & \\ 
& {\tt CRVAL2B} = 1 - {\rm preh} + (S_s + 1) \times {\rm dimh} &  \\
& {\tt PC1\_1Q} = 0 &   \\
& {\tt PC1\_2Q} = 1 & \\
& {\tt PC2\_1Q} = -1 & \\
& {\tt PC2\_2Q} = 0 & \\ 
& {\tt CRVAL1Q} = 1 + {\rm crdim} + {\rm overhang} - {\rm ccdpy}/2 + ({\rm ccdpx} + {\rm ccdax})/4 & \\
& {\tt CRVAL2Q} = 1 - {\rm preh} + (S_s + 1) \times {\rm dimh} + 1 + {\rm crdim} + {\rm overhang}- {\rm yoff1} - {\rm ccdpx} - ({\rm ccdpx} - {\rm ccdax})/2 &  \\
\end{flalign*}
...
& {\tt CRVAL2R} =   1 - {\rm preh} + (7 - S_s) \times {\rm dimh} + {\rm crdim} - {\rm yoff1} - {\rm ccdpx}  + ({\rm ccdpx} - {\rm ccdax})/2 & \\ 
& {\tt PC1\_1F} = 0 & \\
& {\tt PC1\_2F} = -1  & \\
& {\tt PC2\_1F} = 1 & \\
& {\tt PC2\_2F} = 0 & \\
& {\tt CRVAL1F} =  {\rm dimv} + 1 + {\rm crdim} + {\rm overhang} - {\rm ccdpy} - {\rm xoff1} + ({\rm ccdpx} - {\rm ccdax})/4  + R_x \times {\rm raftx} & \\ 
& {\tt CRVAL2F} = 1 - {\rm preh} + (7 - S_s) \times {\rm dimh} + {\rm crdim} - {\rm yoff1} - {\rm ccdpx}  + ({\rm ccdpx} - {\rm ccdax})/2 + R_y \times {\rm rafty} & \\  
& {\tt PC1\_1B} = 0 &   \\
& {\tt PC1\_2B} = -1 & \\
& {\tt PC2\_1B} = 1 & \\
& {\tt PC2\_2B} =  0 &  \\
& {\tt CRVAL1B} = {\rm dimv} + 1 &  \\ 
& {\tt CRVAL2B} = (S_s + 1) \times {\rm dimh} + 1 - {\rm preh} & \\
& {\tt PC1\_1Q} = -1  &  \\
& {\tt PC1\_2Q} = 0 & \\
& {\tt PC2\_1Q} = 0 & \\
& {\tt PC2\_2Q} = -1 &  \\ 
& {\tt CRVAL1Q} = {\rm dimv} + 1 + {\rm crdim} + {\rm overhang} - {\rm xoff1} - {\rm ccdpy} + ({\rm ccdpx} - {\rm ccdax})/4  & \\
& {\tt CRVAL2Q} = (S_s + 1) \times {\rm dimh} + 1 - {\rm preh} + {\rm crdim} + {\rm overhang} - {\rm yoff1} - {\rm ccdpy} + ({\rm ccdpx} - {\rm ccdax})/2 & \\
\end{flalign*}
...
& {\tt PC2\_1A} = -1 & \\
& {\tt PC2\_2A} = 0 & \\
& {\tt CRVAL1A} =  1 + S_x \times {\rm dimv} \\
& {\tt CRVAL2A} =  1 + {\rm dimh} - {\rm preh}  & \\
& {\tt PC1\_1C} = 0 & \\
& {\tt PC1\_2C} = 1 - 2 \times S_x & \\
& {\tt PC2\_1C} = -1 & \\
& {\tt PC2\_2C} = 0 & \\
& {\tt CRVAL1C} = 1 + 2 \times S_x \times {\rm dimv} & \\
& {\tt CRVAL2C} = 1 - {\rm preh} + (8 - S_y) \times {\rm dimh}  & \\ 
& {\tt PC1\_1R} = 0 & \\
& {\tt PC1\_2R} = 1 - 2 \times S_x & \\
& {\tt PC2\_1R} = -1 & \\
& {\tt PC2\_2R} = 0 & \\
& {\tt CRVAL1R} = 1 + 2 \times S_x \times {\rm dimv} + ({\rm ccdpy} - {\rm ccday})/2 & \\ 
& {\tt CRVAL2R} = 1 - {\rm preh} + (8 - S_y) \times {\rm dimh} + {\rm crdim} - {\rm ccdpy} - {\rm xoff1} - {\rm xoff2} + ({\rm ccdpx} - {\rm ccdax})/2 & \\ 
& {\tt PC1\_1F} = 0 & \\
& {\tt PC1\_2F} = 1 - 2 \times S_x & \\
& {\tt PC2\_1F} = -1 & \\
& {\tt PC2\_2F} = 0 & \\
& {\tt CRVAL1F} = 1 + 2 \times S_x \times {\rm dimv} + ({\rm ccdpy} - {\rm ccday})/2 + R_x \times {\rm raftx} &  \\ 
& {\tt CRVAL2F} = 1 - {\rm preh} + (8 - S_y) \times {\rm dimh} + {\rm crdim} - {\rm ccdpy} - {\rm xoff1} - {\rm xoff2} + ({\rm ccdpx} - {\rm ccdax})/2 + R_y \times {\rm rafty} & \\  
& {\tt PC1\_1B} = 1 & \\
& {\tt PC1\_2B} =  0 & \\
& {\tt PC2\_1B} = 0 &  \\
& {\tt PC2\_2B} = 1 - 2 \times S_p &  \\
& {\tt CRVAL1B} = 1 - {\rm preh} + (7 - S_s) \times {\rm dimh}  & \\ 
& {\tt CRVAL2B} = 1 + 2 \times {\rm dimv} \times S_p & \\
& {\tt PC1\_1Q} = 1  &  \\
& {\tt PC1\_2Q} = 0  & \\
& {\tt PC2\_1Q} = 0 & \\
& {\tt PC2\_2Q} = 1 - 2 \times S_p  & \\
& {\tt CRVAL1Q} = 1 - {\rm preh} + (7 - S_s) \times {\rm dimh} + {\rm overhang} + {\rm ccdpy} + {\rm xoff1} + {\rm xoff2} + ({\rm ccdpx} - {\rm ccdax})/2  & \\
& {\tt CRVAL2Q} =  1 + 2 \times {\rm dimv} \times S_p &  \\
\end{flalign*}
...
& {\tt PC2\_1R} = 0 & \\
& {\tt PC2\_2R} = 2 \times S_x  - 1 & \\
& {\tt CRVAL1R} = 1 - {\rm preh}  + (8 - S_y) \times {\rm dimh} + {\rm overhang} + {\rm yoff1} + {\rm yoff2} + {\rm ccdpy} + ({\rm ccdpy} - {\rm ccday})/2 & \\
& {\tt CRVAL2R} =  1 + 2 \times (1 - S_x) \times {\rm dimv} + {\rm crdim} + {\rm overhang} - {\rm ccdpx} + ({\rm ccdpx} - {\rm ccdax})/2  & \\
& {\tt PC1\_1F} = -1 & \\
& {\tt PC1\_2F} = 0 & \\
& {\tt PC2\_1F} = 0 & \\
& {\tt PC2\_2F} =  2 \times S_x - 1 & \\
& {\tt CRVAL1F} = 1 - {\rm preh}  + (8 - S_y) \times {\rm dimh} + {\rm overhang} + {\rm yoff1} + {\rm yoff2} + {\rm ccdpy} + ({\rm ccdpy} - {\rm ccday})/2 + R_x \times {\rm raftx} & \\ 
& {\tt CRVAL2F} =  1 + 2 \times (1 - S_x) \times {\rm dimv} + {\rm crdim} + {\rm overhang} - {\rm ccdpx} + ({\rm ccdpx} - {\rm ccdax})/2 + R_y \times {\rm rafty} & \\  
& {\tt PC1\_1B} = 0 & \\
& {\tt PC1\_2B} = 1 - 2 \times S_p  & \\
& {\tt PC2\_1B} = -1 & \\
& {\tt PC2\_2B} =  0 & \\
& {\tt CRVAL1B} =  1 + 2 \times S_p \times {\rm dimv} & \\ 
& {\tt CRVAL2B} = 1 - {\rm preh} + (8 - S_s) \times {\rm dimh} & \\
& {\tt PC1\_1Q} = 0 &  \\
& {\tt PC1\_2Q} = 1 - 2 \times S_p & \\
& {\tt PC2\_1Q} = 1 & \\
& {\tt PC2\_2Q} = 0 & \\
& {\tt CRVAL1Q} = 1 + 2 \times S_p \times {\rm dimv} &  \\
& {\tt CRVAL2Q} = 1 - {\rm preh} + (8 - S_s) \times {\rm dimh} + {\rm overhang} + {\rm yoff1} + {\rm yoff2} + {\rm ccdpy} - ({\rm ccdpy} - {\rm ccday})/2 &  \\
\end{flalign*}
...
& {\tt PC2\_1C} = 0 & \\
& {\tt PC2\_2C} = 1 &  \\
& {\tt CRVAL1C} = 1 + {\rm dimh} - {\rm preh} + (7 - S_s) \times {\rm dimh} &  \\
& {\tt CRVAL2C} =  1 + S_p \times {\rm dimv} & \\ 
& {\tt PC1\_1R} = 1 & \\
& {\tt PC1\_2R} = 0  & \\
& {\tt PC2\_1R} = 0 & \\
& {\tt PC2\_2R} = 1 & \\
& {\tt CRVAL1R} = 1 + {\rm dimh} - {\rm preh} + (7 - S_s) \times {\rm dimh} + {\rm overhang} + {\rm yoff1} + ({\rm ccdpy} - {\rm ccday})/2  &  \\
& {\tt CRVAL2R} = 1 + S_p \times {\rm dimv} + {\rm crdim} + {\rm overhang} - {\rm ccdpx}/2 + ({\rm ccdpx} - {\rm ccdax})/4 & \\ 
& {\tt PC1\_1F} = 1 & \\
& {\tt PC1\_2F} = 0  & \\
& {\tt PC2\_1F} = 0 & \\
& {\tt PC2\_2F} = 1 & \\
& {\tt CRVAL1F} = 1 + {\rm dimh} - {\rm preh} + (7 - S_s) \times {\rm dimh} + {\rm overhang} + {\rm yoff1} + ({\rm ccdpy} - {\rm ccday})/2 + R_x \times {\rm raftx} & \\ 
& {\tt CRVAL2F} = 1 + S_p \times {\rm dimv} + {\rm crdim} + {\rm overhang} - {\rm ccdpx}/2 + ({\rm ccdpx} - {\rm ccdax})/4 + R_y \times {\rm rafty} & \\  
& {\tt PC1\_1B} = 0 &   \\
& {\tt PC1\_2B} = -1 & \\
& {\tt PC2\_1B} = 1 & \\
& {\tt PC2\_2B} = 0 & \\
...
& {\tt PC2\_2Q} = 0 & \\ 
& {\tt CRVAL1Q} = 1 + {\rm dimv} & \\
& {\tt CRVAL2Q} = 1 - {\rm preh} + (7 - S_s) \times {\rm dimh} + {\rm overhang} + {\rm yoff1} + ({\rm ccdpy} - {\rm ccday})/2 &  \\
\end{flalign*}
...
& {\tt PC2\_1R} = 0 & \\
& {\tt PC2\_2R} = -1 & \\
& {\tt CRVAL1R} = 1 - {\rm preh} + (8 - S_y) \times {\rm dimh} + {\rm overhang} + {\rm yoff1} + ({\rm ccdpy} - {\rm ccday})/2 & \\
& {\tt CRVAL2R} = 1 + {\rm dimv} + {\rm crdim} + {\rm overhang} - {\rm ccdpx} - {\rm xoff1} + ({\rm ccdpx} - {\rm ccdax})/4 & \\ 
& {\tt PC1\_1F} = -1 & \\
& {\tt PC1\_2F} = 0  & \\
& {\tt PC2\_1F} = 0 & \\
& {\tt PC2\_2F} = -1 & \\
& {\tt CRVAL1F} =  1 - {\rm preh} + (8 - S_y) \times {\rm dimh} + {\rm overhang} + {\rm yoff1} + ({\rm ccdpy} - {\rm ccday})/2  + R_x \times {\rm raftx} & \\ 
& {\tt CRVAL2F} = 1 + {\rm dimv} + {\rm crdim} + {\rm overhang} - {\rm ccdpx} - {\rm xoff1} + ({\rm ccdpx} - {\rm ccdax})/4 + R_y \times {\rm rafty} & \\  
& {\tt PC1\_1B} = 0 &   \\
& {\tt PC1\_2B} = 1 & \\
& {\tt PC2\_1B} = -1 & \\
& {\tt PC2\_2B} =  0 &  \\
...
& {\tt CRVAL2Q} = (S_s + 1) \times {\rm dimh} + 1 - {\rm preh} + {\rm yoff1} + ({\rm ccdpy} - {\rm ccday})/2 & \\
\end{flalign*}
...
& {\tt PC2\_2A} = 1 - 2 \times S_x & \\
& {\tt CRVAL1A} =  1 - {\rm preh} \\
& {\tt CRVAL2A} =  S_x \times {\rm dimv} + 1 & \\
& {\tt PC1\_1C} = 1 & \\
& {\tt PC1\_2C} = 0 & \\
& {\tt PC2\_1C} = 0 & \\
& {\tt PC2\_2C} = 1 - 2 \times S_x & \\
& {\tt CRVAL1C} = 1 - {\rm preh} + (7 - S_y) \times {\rm dimh} & \\
& {\tt CRVAL2C} = 2 \times S_x \times {\rm dimv} + 1  & \\ 
& {\tt PC1\_1R} = 1 & \\
& {\tt PC1\_2R} = 0 & \\
& {\tt PC2\_1R} = 0 & \\
& {\tt PC2\_2R} = 1 - 2 \times S_x & \\
& {\tt CRVAL1R} = 1 - {\rm preh} + (7-S_y) \times {\rm dimh} + {\rm overhang} + {\rm ccday} + ({\rm ccdpx} - {\rm ccdax})/2 + {\rm xoff1} + {\rm xoff2} & \\  
& {\tt CRVAL2R} = 2 \times S_x \times {\rm dimv} + 1 + ({\rm ccdpy} - {\rm ccday})/2 & \\ 
& {\tt PC1\_1F} = 1 & \\
& {\tt PC1\_2F} = 0 & \\
& {\tt PC2\_1F} = 0 & \\
& {\tt PC2\_2F} = 1 - 2 \times S_x & \\
& {\tt CRVAL1F} = 1 - {\rm preh} + (7 - S_y) \times {\rm dimh} + {\rm overhang} + {\rm ccday} + ({\rm ccdpx} - {\rm ccdax})/2 + {\rm xoff1} + {\rm xoff2} + R_x \times {\rm raftx} &  \\ 
& {\tt CRVAL2F} = 2 \times S_x \times {\rm dimv} + 1 + ({\rm ccdpy} - {\rm ccday})/2 + R_y \times {\rm rafty} & \\  
& {\tt PC1\_1B} = 0 & \\
& {\tt PC1\_2B} = -1 + 2 \times S_p & \\
& {\tt PC2\_1B} = 1 &  \\
& {\tt PC2\_2B} = 0 &  \\
& {\tt CRVAL1B} = 2 \times (S_p - 1) \times {\rm dimv} + 1  & \\ 
& {\tt CRVAL2B} = 1 - {\rm preh} + (7 - S_s) \times {\rm dimh} & \\
& {\tt PC1\_1Q} = 0  &  \\
& {\tt PC1\_2Q} = -1 + 2 \times S_p & \\
& {\tt PC2\_1Q} = 1 & \\
& {\tt PC2\_2Q} = 0  & \\
& {\tt CRVAL1Q} =  2 \times (S_p - 1) \times {\rm dimv} + 1 + {\rm crdim} - {\rm ccdpy} & \\
& {\tt CRVAL2Q} = 1 - {\rm preh} + (7 - S_s) \times {\rm dimh} +  {\rm ccdpy} + ({\rm ccdpx} - {\rm ccdax})/2 + {\rm xoff1} + {\rm xoff2} &  \\
\end{flalign*}
...
& {\tt PC2\_1A} = -1 &  \\
& {\tt PC2\_2A} = 0 & \\
& {\tt CRVAL1A} =   S_x \times {\rm dimv} + 1 - {\rm preh} & \\
& {\tt CRVAL2A} = {\rm dimh} + 1 - {\rm preh}  & \\
& {\tt PC1\_1C} = 0 & \\
& {\tt PC1\_2C} = -1 + 2 \times S_x & \\
& {\tt PC2\_1C} = -1 & \\
& {\tt PC2\_2C} = 0 & \\
& {\tt CRVAL1C} = 2 \times S_x \times {\rm dimv} + 1 - {\rm preh}  & \\
& {\tt CRVAL2C} =  {\rm dimh} + 1 - {\rm preh} + S_y \times {\rm dimh}  &  \\ 
& {\tt PC1\_1R} = 0 & \\
& {\tt PC1\_2R} = -1 + 2 \times S_x & \\
& {\tt PC2\_1R} = -1) & \\
& {\tt PC2\_2R} = 0 & \\
& {\tt CRVAL1R} = 2 \times S_x \times {\rm dimv} + 1 - {\rm preh}  + ({\rm ccdpy} - {\rm ccday})/2 & \\
& {\tt CRVAL2R} =  {\rm dimh} + 1 - {\rm preh} + S_y \times {\rm dimh} + {\rm yoff1} + {\rm yoff2} + 8 \times {\rm dimh} + {\rm ccdpy} -  {\rm ccday} + {\rm overhang} & \\
& {\tt PC1\_1F} = 0 & \\
& {\tt PC1\_2F} = -1 + 2 \times S_x & \\
& {\tt PC2\_1F} = -1 &  \\
& {\tt PC2\_2F} =  0 & \\
& {\tt CRVAL1F} = 2 \times S_x \times {\rm dimv} + 1 - {\rm preh}  +  ({\rm ccdpy} - {\rm ccday})/2  + R_x \times {\rm raftx} & \\ 
& {\tt CRVAL2F} = {\rm dimh} + 1 - {\rm preh} + S_y \times {\rm dimh} + {\rm yoff1} + {\rm yoff2} + 8 \times {\rm dimh} + {\rm ccdpy} - {\rm ccday} + {\rm overhang} + R_y \times {\rm rafty} & \\  
& {\tt PC1\_1B} = 0 &   \\
& {\tt PC1\_2B} = 2 \times S_p - 1 & \\
& {\tt PC2\_1B} =  1  & \\
& {\tt PC2\_2B} = 0 & \\
& {\tt CRVAL1B} = (7 - S_s) \times {\rm dimh} + 1 - {\rm preh} & \\ 
& {\tt CRVAL2B} = 1 + 2 \times S_p \times {\rm dimv} & \\
& {\tt PC1\_1Q} = 1  &  \\
& {\tt PC1\_2Q} = 0 & \\
& {\tt PC2\_1Q} = 0 & \\
& {\tt PC2\_2Q} = 1 - 2 \times S_p & \\
& {\tt CRVAL1Q} = {\rm yoff1} + {\rm yoff2} + ({\rm ccdpy} - {\rm ccday})/2 + (7 - S_s) \times {\rm dimh} + 1 - {\rm preh} &  \\
& {\tt CRVAL2Q} = 2 \times S_p \times {\rm dimv} + ({\rm ccdpy} - {\rm ccday})/2 &  \\
\end{flalign*}
...
& {\tt CRVAL2R} =  1 - {\rm preh} + (7 - S_s) \times {\rm dimh} + {\rm yoff1} + {\rm overhang} & \\ 
& {\tt PC1\_1F} = 0 & \\
& {\tt PC1\_2F} = -1  & \\
& {\tt PC2\_1F} = 1 & \\
& {\tt PC2\_2F} = 0 & \\
& {\tt CRVAL1F} = {\rm dimv} + 1 + ({\rm ccdpy} - {\rm ccday})/2  + R_x \times {\rm raftx} & \\ 
& {\tt CRVAL2F} = 1 - {\rm preh} + (7 - S_s) \times {\rm dimh} + {\rm yoff1} + {\rm overhang} + R_y \times {\rm rafty} & \\  
& {\tt PC1\_1B} = -1 &   \\
& {\tt PC1\_2B} = 0 & \\
& {\tt PC2\_1B} = 0 & \\
& {\tt PC2\_2B} =  -1 & \\
...
& {\tt PC2\_1Q} = 0 & \\
& {\tt PC2\_2Q} = -1 & \\ 
& {\tt CRVAL1Q} = {\rm overhang} + {\rm yoff1} +  (7 -  S_s) \times {\rm dimh} + 1 - {\rm preh} & \\
...
& {\tt PC2\_2C} = 0 & \\
& {\tt CRVAL1C} = 1 &  \\
& {\tt CRVAL2C} =  {\rm dimh}  + 1 - {\rm preh} + S_s \times {\rm dimh} &  \\ 
& {\tt PC1\_1R} = 0 & \\
& {\tt PC1\_2R} = 1 &  \\
& {\tt PC2\_1R} = -1 & \\
& {\tt PC2\_2R} = 0 & \\
& {\tt CRVAL1R} = 1 + ({\rm ccdpx} - {\rm ccdax})\times (3/4) + {\rm dimv} + {\rm offx1} & \\
& {\tt CRVAL2R} =   {\rm dimh} - {\rm preh} + S_s \times {\rm dimh}  + {\rm overhang} & \\ 
& {\tt PC1\_1F} = 0 & \\
& {\tt PC1\_2F} = 1  & \\
& {\tt PC2\_1F} = -1 & \\
& {\tt PC2\_2F} = 0 & \\
& {\tt CRVAL1F} = 1 + ({\rm ccdpx} - {\rm ccdax})\times (3/4) + {\rm dimv} + {\rm offx1} + R_x \times {\rm raftx} & \\ 
& {\tt CRVAL2F} = {\rm dimh} + 1 - {\rm preh} + S_s \times {\rm dimh}  + {\rm overhang} + R_y \times {\rm rafty} & \\  
& {\tt PC1\_1B} = 1 &   \\
& {\tt PC1\_2B} = 0 & \\
& {\tt PC2\_1B} = 0 & \\
& {\tt PC2\_2B} =  1 &  \\
...
& {\tt PC2\_1Q} = 0 & \\
& {\tt PC2\_2Q} = 1 &  \\ 
& {\tt CRVAL1Q} = {\rm overhang} + {\rm yoff1} +  S_s \times {\rm dimh} + 1 - {\rm preh} & \\
