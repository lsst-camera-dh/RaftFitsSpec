...
\red{13 Mar 2017:  Corrected example directory path and file name in Sec. 6.2 to include test version in the path and run ID in the file name.}
...
\red{Here the sequence number is 003, the run ID is 1234, and the time stamp is 20160121191343.  Please do not assume that the job ID (36123 here) is limited to 5 digits, or that the run ID (1234 here) is limited to four.  The sequence number is specified to be three digits, and is not expected to exceed 999.}
