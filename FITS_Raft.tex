...
& {\tt PC2\_1R} = 1 & \\
& {\tt PC2\_2R} = 0 & \\
& {\tt CRVAL1R} = 1 + 2 \times (1 - S_y) \times {\rm dimv} + {\rm crdim} + {\overhang} - {\rm ccdpy} + ({\rm ccdpy - {\rm ccday})/2 & \\ 
& {\tt CRVAL2R} = 1 - {\rm preh} + (7 - S_x) \times {\rm dimh} + {\rm overhang} + {\rm ccdpy} + {\rm xoff1} + {\rm xoff2} + ({\rm ccdpx} - {\rm ccdax})  & \\ 
& {\tt PC1\_1F} = 0 & \\
& {\tt PC1\_2F} = -1 + 2 \times S_y & \\
& {\tt PC2\_1F} = 1 & \\
& {\tt PC2\_2F} = 0 & \\
& {\tt CRVAL1F} = 1 + 2 \times (1 - S_y) \times {\rm dimv} + {\rm crdim} + {\overhang} - {\rm ccdpy} + ({\rm ccdpy - {\rm ccday})/2 + R_x \times {\rm raftx} &  \\ 
...
& {\tt CRVAL2F} =  1 + 2 \times S_x \times {\dimv} + R_y \times {\rm rafty} & \\  
& {\tt PC1\_1B} = 0 &   \\
& {\tt PC1\_2B} = -1 + 2 \times S_p  & \\
& {\tt PC2\_1B} = 1 & \\
& {\tt PC2\_2B} =  0 & \\
