...
\end{equation}
\begin{equation}
x_0 = {\rm overh} + {\rm ccday} + ({\rm ccdpx} - {\rm ccdax})/2 + {\rm xoff1} + {\rm xoff2} + x_c
\end{equation}
\begin{equation}
...
\end{equation}
\begin{equation}
x_0 = {\rm overh} + {\rm ccdax}/2 + {\rm ccdpx}/2 + {\rm xoff1} + x_c
\end{equation}
\begin{equation}
y_0 = ({\rm ccday} - {\rm ccdpy})/2 + {\rm yoff1} + y_c
\end{equation}
...
The following equations define the WCS coordinate keyword values for the {\bf Gdr1} sensor in corner raft {\bf R44}:
%\begin{table}
\begin{align*}
& {\tt PC1\_1A} = 1 \\
& {\tt PC1\_2A} = 0 \\
& {\tt PC2\_1A} = S_x \times ({\rm dimv} + 1) \\
...
& {\tt CRVAL2F} = 2 \times S_y \times {\rm dimh} + 1 - {\rm preh} + S_x \times {\rm dimv} + ({\rm ccdpy} - {\rm ccday})/2 R_x \times {\rm rafty} \\  
& {\tt PC1\_1B} = 0   \\
& {\tt PC1\_2B} = 1 \\
& {\tt PC2\_1B} = 1 \\
& {\tt PC2\_2B} = 0 \\
...
& {\tt CRPIX1B} = 0 \\
& {\tt CRPIX2B} = 0 \\
& {\tt CRVAL1B} = TBD \\ %(S_s + 1) \times {\rm dimh} + 1 - {\rm preh} \\
& {\tt CRVAL2B} = TBD \\ %S_p \times (2 \times {\rm dimv} + 1)  \\
& {\tt PC1\_1Q} = 0   \\
& {\tt PC1\_2Q} = 1 \\
& {\tt PC2\_1Q} = 1 \\
& {\tt PC2\_2Q} = 0  \\
...
& {\tt CRPIX1Q} = 0 \\
& {\tt CRPIX2Q} = 0 \\
& {\tt CRVAL1Q} = 2 \times S_y \times {\rm dimh} + 1 - {\rm preh} + S_x \times {\rm dimv} + ({\rm ccdpy} - {\rm ccday})/2 \\
& {\tt CRVAL2Q} =1 - {\rm preh} + (7-S_y) \times {\rm dimh} + {\rm overh} + {\rm ccday} + ({\rm ccdpx} - {\rm ccdax})/2 + {\rm xoff1} + {\rm xoff2} \\
\end{align*}
