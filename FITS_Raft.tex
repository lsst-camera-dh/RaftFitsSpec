...
The meanings of the keywords in the primary headers are described in the comments fields of the example headers in Tables \ref{tab:primary_E2V} and \ref{tab:primary_ITL}, and are intended to be the same as in the single sensor data sets for TS3.  In particular, the keywords {\tt TESTTYPE} and {\tt IMGTYPE} have the same allowed values as used for single sensor tests with TS3.
