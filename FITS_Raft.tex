...
\end{equation}
\begin{equation}
y_c = (1 - S_x) ( y_s + 1) +  S_x ( {\rm dimv} - y_s) {\rm dimv}
\end{equation}
\begin{equation}
x_0 = {\rm overhang} + {\rm ccday} + ({\rm ccdpx} - {\rm ccdax})/2 + {\rm xoff1} + {\rm xoff2} + x_c
\end{equation}
\begin{equation}
...
Gdr2:
\begin{equation}
x_c =  S_x \times y_s + 1 + (1 - S_x)({\rm dimv} - y_s)
\end{equation}
\begin{equation}
y_c = S_y \times {\rm dimh} + 1  + x_s
\end{equation}
\begin{equation}
x_0 = xc + ({\rm ccday} - {\rm ccdpy})/2
\end{equation}
\begin{equation}
y_0 = {\rm over} + {\rm ccdax} + ({\rm ccday} - {\rm ccdpy})/2 + {\rm yoff1} + {\rm yoff2} + y_c
\end{equation}
...
\end{equation}
\begin{equation}
x_0 = {\rm over} + ({\rm ccdax} - {\rm ccdpx})/2 + x_c 
\end{equation}
\begin{equation}
y_0 = ({\rm ccday} - {\rm ccdpy})/2 + {\rm yoff1} + y_c
\end{equation}
...
\end{equation}
\begin{equation}
x_0 = {\rm overhang} + {\rm ccdax}/2 + {\rm ccdpx}/2 + {\rm xoff1} + x_c
\end{equation}
\begin{equation}
y_0 = ({\rm ccday} - {\rm ccdpy})/2 + {\rm yoff1} + y_c
\end{equation}
...
%In R40, Gdr1 is aligned as for the ITL sensors in the science rafts
%In R44, Gdr2 is aligned as for the ITL sensors in the science rafts
...
& {\tt CRVAL1A} =  1 - {\rm preh} \\
& {\tt CRVAL2A} = 2 \times S_y \times {\rm dimh} + 1 - {\rm preh} \\
& {\tt PC1\_1C} = 1 \\
& {\tt PC1\_2C} = 0 \\
& {\tt PC2\_1C} = 0 \\
& {\tt PC2\_2C} = 1 - 2 \times S_x \\
& {\tt CRVAL1C} = 1 - {\rm preh} + (7-S_y) \times {\rm dimh} \\
& {\tt CRVAL2C} = 2 \times S_y \times {\rm dimh} + 1 - {\rm preh} + S_x \times {\rm dimv} \\ 
& {\tt PC1\_1R} = 1 \\
& {\tt PC1\_2R} = 0 \\
& {\tt PC2\_1R} = 0 \\
& {\tt PC2\_2R} = 1 - 2 \times S_x \\
& {\tt CRVAL1R} = 1 - {\rm preh} + (7-S_y) \times {\rm dimh} + {\rm overh} + {\rm ccday} + ({\rm ccdpx} - {\rm ccdax})/2 + {\rm xoff1} + {\rm xoff2} \\  
& {\tt CRVAL2R} = 2 \times S_y \times {\rm dimh} + 1 - {\rm preh} + S_x \times {\rm dimv} + ({\rm ccdpy} - {\rm ccday})/2 \\ 
& {\tt PC1\_1F} = 1 \\
& {\tt PC1\_2F} = 0 \\
& {\tt PC2\_1F} = 0 \\
...
& {\tt PC2\_1B} = 1 \\
& {\tt PC2\_2B} = 0 \\
& {\tt CRVAL1B} = 2 \times S_p \times {\rm dimh} + 1 - {\rm preh} + S_s \times {\rm dimv} \\ 
& {\tt CRVAL2B} = 1 - {\rm preh} + (7-S_p) \times {\rm dimh} \\
& {\tt PC1\_1Q} = 0   \\
& {\tt PC1\_2Q} = 1 \\
& {\tt PC2\_1Q} = 1 \\
& {\tt PC2\_2Q} = 0  \\
& {\tt CRVAL1Q} = 2 \times S_p \times {\rm dimh} + 1 - {\rm preh} + S_s \times {\rm dimv} + ({\rm ccdpy} - {\rm ccday})/2 \\
& {\tt CRVAL2Q} = 1 - {\rm preh} + (7-S_p) \times {\rm dimh} + {\rm overhang} + {\rm ccday} + ({\rm ccdpx} - {\rm ccdax})/2 + {\rm xoff1} + {\rm xoff2} \\
\end{align*}
...
& {\tt PC2\_1F} = -1 )&  \\
& {\tt PC2\_2F} =  0 & \\
& {\tt CRVAL1F} = {\rm dimh} + 1 - {\rm preh} + S_y \times {\rm dimh} + {\rm yoff1} + {\rm yoff2} + 8 \times {\rm dimh} + {\rm ccdpy} - {\rm ccday} + {\rm overhang} + R_x \times {\rm raftx} & \\ 
