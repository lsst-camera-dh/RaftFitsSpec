...
& {\tt PC2\_1F} = 1 & \\
& {\tt PC2\_2F} = 0 & \\
& {\tt CRVAL1F} = 1 + 2 \times (1 - S_y) \times {\rm dimv} + {\rm crdim} + {\rm overhang} - {\rm ccdpy} + ({\rm ccdpy} - {\rm ccday})/2 + R_x \times {\rm raftx} &  \\ 
...
& {\tt CRVAL2R} =  1 + 2 \times (1 - S_y) \times {\rm dimv} + {\rm crdim} + {\rm overhang} - {\rm ccdpx} + ({\rm ccdpx} - {\rm ccdax})/2  & \\
& {\tt PC1\_1F} = -1 & \\
& {\tt PC1\_2F} = 0 & \\
& {\tt PC2\_1F} = 0 & \\
& {\tt PC2\_2F} =  2 \times S_x - 1 & \\
& {\tt CRVAL1F} = 1 - {\rm preh}  + (8 - S_y) \times {\rm dimh} + {\rm overhang} + {\rm yoff1} + {\rm yoff2} + {\rm ccdpy} + ({\rm ccdpy} - {\rm ccday})/2 + R_x \times {\rm raftx} & \\ 
& {\tt CRVAL2F} =  1 + 2 \times (1 - S_y) \times {\rm dimv} + {\rm crdim} + {\rm overhang} - {\rm ccdpx} + ({\rm ccdpx} - {\rm ccdax})/2 + R_y \times {\rm rafty} & \\  
& {\tt PC1\_1B} = 0 & \\
& {\tt PC1\_2B} = 1 - 2 \times S_p  & \\
& {\tt PC2\_1B} = -1 & \\
& {\tt PC2\_2B} =  0 & \\
...
& {\tt CRVAL2B} = 1 - {\rm preh} + (7 - S_p) \times {\rm dimh} & \\
& {\tt PC1\_1Q} = 0  &  \\
& {\tt PC1\_2Q} = -1 + 2 \times S_p & \\
& {\tt PC2\_1Q} = 1 & \\
& {\tt PC2\_2Q} = 0  & \\
& {\tt CRVAL1Q} =  2 \times (S_p - 1) \times {\rm dimv} + 1 + {\rm crdim} - {\rm ccdpy} & \\
& {\tt CRVAL2Q} = 1 - {\rm preh} + (7-S_p) \times {\rm dimh} +  {\rm ccdpy} + ({\rm ccdpx} - {\rm ccdax})/2 + {\rm xoff1} + {\rm xoff2} &  \\
\end{flalign*}
