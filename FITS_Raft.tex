...
& {\tt PC2\_1R} = 0 & \\
& {\tt PC2\_2R} = 2 \times S_x  - 1 & \\
& {\tt CRVAL1R} = 1 - {\rm preh}  + (8 - S_y) \times {\rm dimh} + {\rm overhang} + {\rm yoff1} + {\rm yoff2} + {\rm ccdpx} + ({\rm ccdpx} - {\rm ccdax})/2 & \\
& {\tt CRVAL2R} =  1 + 2 \times (1 - S_y) \times {\rm dimv} + {\rm crdim} + {\rm overhang} - {\rm ccdpy} + ({\rm ccdpy} - {\rm ccday})/2  & \\
& {\tt PC1\_1F} = -1 & \\
& {\tt PC1\_2F} = 0 & \\
& {\tt PC2\_1F} = 0 & \\
& {\tt PC2\_2F} =  2 \times S_x - 1 & \\
...
& {\tt PC2\_1R} = 0 & \\
& {\tt PC2\_2R} = 1 - 2 \times S_x & \\
& {\tt CRVAL1R} = 1 - {\rm preh} + (7-S_y) \times {\rm dimh} + {\rm overh} + {\rm ccday} + ({\rm ccdpx} - {\rm ccdax})/2 + {\rm xoff1} + {\rm xoff2} & \\  
& {\tt CRVAL2R} = 2 \times S_x \times {\rm dimv} + 1 + ({\rm ccdpy} - {\rm ccday})/2 & \\ 
& {\tt PC1\_1F} = 1 & \\
& {\tt PC1\_2F} = 0 & \\
& {\tt PC2\_1F} = 0 & \\
& {\tt PC2\_2F} = 1 - 2 \times S_x & \\
& {\tt CRVAL1F} = 1 - {\rm preh} + (7 - S_y) \times {\rm dimh} + {\rm overh} + {\rm ccday} + ({\rm ccdpx} - {\rm ccdax})/2 + {\rm xoff1} + {\rm xoff2} + R_x \times {\rm raftx} &  \\ 
